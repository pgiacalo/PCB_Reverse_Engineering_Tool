...
export interface MenuBarProps {
  ...
  setShowMemoryMonitor: (show: boolean) => void;
  // PastMachine
        ...
        >
          ...
          >
            ...
            <div style={{ 
              ...
              <h2 style={{ margin: 0, color: '#f2f2f2', fontSize: '20px', fontWeight: 700 }}>PCB Tracer (v3.3) - Documentation</h2>
        <button 
                onClick={() => setShowDocumentationDialog(false)}
          style={{ 
                  background: 'none',
            ...
            <div style={{ 
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <ul style={{ margin: '0 0 12px 0', paddingLeft: '20px', color: '#f2f2f2', fontSize: '14px', lineHeight: '1.6' }}>
                  ...
                  <li><strong>Change Perspective:</strong> Tools → Change Perspective (or press <code>E</code>) to switch between top/bottom view or rotate all elements (images, components, traces) together by 45°, 90°, 180°, or 270°.</li>
